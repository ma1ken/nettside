    ...
    <div className="content-container my-work-page eld-page">
        ...
        <div className="text-image-section">
          <div className="about-text">
            ...
            <p>
              ...
              young workers/students and the elderly was meant to enhance the
              quality of life for seniors and help society adapt to the growing
              elderly population.
            </p>
          </div>
          ...
          <div className="about-text">
            ...
            <p>
              ...
              housing. Simultaneously, many elderly individuals experienced
              loneliness and a lack of social interaction, with 1 in 3 living
              alone. Our solution aimed to bridge these two groups through a
              digital platform that facilitated part-time work and social
              engagement while also addressing the broader societal challenge of
              an aging population.
            </p>
          </div>
        </div>
      ...
      <div>
        ...
        <p>
          ...
          were the same ones we later used during usability testing in the next
          phase.
        </p>
      </div>
      ...
      <div className="">
        <p>
          In our sitemap, we developed a complete overview of the app from the
          landing page through the various flows for both target groups. The
          version presented for the younger demographic (students) was intended
          as a concept for future development, as we didn't have the capacity to
          fully build out both sides. However, we took the preferences of
          younger users into account in Part 4, which could serve as inspiration
      ...
      <div className="section-color">
        <div>
          ...
          <p>
            ...
            us to gain insight into how they experienced the interface so we
            could optimize typography, button size, colors, and the placement of
            elements. Designing for this demographic required a different
            approach than we had used in previous projects. Regardless of the
            audience, usability testing proved essential for uncovering real
            user needs. We tested four participants aged 65-85 who were
            relatively independent and did not require significant healthcare.
            To get a broad perspective, we included people with both low and
            high levels of digital literacy.
            <br />
            <br />A moderator guided participants through the test while two
            observers watched remotely via webcam. Prior to testing, we obtained
            consent to record video and audio, which helped us later analyze and
            interpret responses.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            ease (green), some difficulty (yellow), or with assistance or
            failure (red)
          </p>
        </div>
        ...
        <div className="text-image-section">
          <div>
            ...
            <p>
              ...
              summaries of each participant's overall competence and comments.
              While some feedback overlapped, most participants pointed out
              different issues based on their individual experiences.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              worked with elderly users before, there were several adjustments
              we realized we should have made earlier.
              <br />
              <br />
              One of the most critical takeaways was the need for a screen
              reader for visually impaired users. One participant had difficulty
              reading and identifying visual contrast. Some button placements
              and layout choices confused several users. What seemed logical to
              us as designers did not align with the users' expectations. We
              received feedback that some interactions needed to be simplified.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section-color">
        ...
        <div className="five-image-section">
          ...
          <img src={eldProto2} alt="Confirm worker checked in page" />
          <img src={eldProto3} alt="Choose if you're elderly or a worker." />
          <img
            src={eldProto4}
            alt="About the worker you're going to meet, confirm or deny page."
          />
          <img src={eldProto5} alt="Login or register page." />
        </div>
      </div>
    </div>
  );
